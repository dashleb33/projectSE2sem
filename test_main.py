...
def test_predict_main():
    ...
    '''
    response = client.post('/summarization/', data={'assignment': '''Katherine Mansfield, an outstanding English short-story writer of the 20th century, was born in New Zealand in 1888 and died in 1923. She is the author of a number of excellent short stories which deal with human nature and psychology.
